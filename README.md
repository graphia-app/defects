...
| [enrichmenttablemodel.cpp:69](https://github.com/graphia-app/graphia/blob/cpp20/source/app/attributes/enrichmenttablemodel.cpp#L69 "source/app/attributes/enrichmenttablemodel.cpp:69"):39 | arithmetic between different enumeration types ('EnrichmentTableModel::Results' and 'Qt::ItemDataRole') is deprecated |
